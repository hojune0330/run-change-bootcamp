...
export function CoachFilters({ model, onCohortChange, onQueryChange }: CoachFiltersProps) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: <search> 엘리먼트가 React에서 DOM 경고를 발생시켜 PR #10 코드리뷰에서 role="search" div로 교체함
    <div aria-label="참가자 필터" className="coach-filters__container" role="search">
